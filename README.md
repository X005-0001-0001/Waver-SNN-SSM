...
Progress	59.8%
📈 训练曲线总览
https://plots/overview.png

上图展示了 Loss、PPL、Activity、LR 和 Memory 的全流程变化曲线（平滑版本）。

📉 分项详细曲线
Loss	PPL
https://plots/loss.png	https://plots/ppl.png
Learning Rate	Memory
https://plots/lr.png	https://plots/memory.png
🧩 层内统计（Layer Stats）
https://plots/layer_stats.png

每层的 I_std、amp_std、wave_raw_mean、wave_raw_std、delta_mean/min/max 变化趋势。

🔧 参数监控（MON Parameters）
https://plots/mon_params.png
...
<details> <summary>点击展开 Layer 监控数据</summary>
...
</details><details> <summary>点击展开 MON 参数</summary>
...
</details><details> <summary>点击展开 MoE 专家监控</summary>
